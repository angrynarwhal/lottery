...
for number in range(57, 76):
    # Calculate the number of draws since the introduction date
    draws_since_introduction = data[data['date'] >= '2019-01-01']['date'].count()
    # Calculate the adjusted probability
    adjusted_probability = number_frequency[number] / draws_since_introduction
    number_probabilities[number] = adjusted_probability
