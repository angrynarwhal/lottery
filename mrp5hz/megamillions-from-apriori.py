...
data = pd.read_csv('/home/maxpeek/CS4320/lottery/megamillions.csv', parse_dates=['date'], date_format='%m-%d-%y')
...
for _, row in data.iterrows():
    ...
    # If the date is before October 5, 2005 it will not have balls up to 75 and so are skipped
    if(datetime.datetime(date) > datetime.datetime(2005, 10, 5)):
        continue
