...
# ... Joshua Jaworski Update

# number of total balls
total_balls = data['date'].count()
# balls 57-75 added on October 22, 2013
# number of balls before date
num_before_date = data[data['date'] <= '2013-10-22']['date'].count()
# number of balls after date
num_after_date = total_balls - num_before_date

# adjust frequency for balls 57-75
for i in range(57,76):
    # formula to normalize
    range_frequency = round((number_frequency[i] / num_after_date) * total_balls)
    number_frequency[i] = range_frequency
...
# Normalization for numbers 57-75
