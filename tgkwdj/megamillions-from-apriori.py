...
for _, row in data.iterrows():
    ...
    # The new numbers start to appear in the year 2013.
    # I thought it would be more accurate to calculate the probability of winning numbers when
    # all the numbers are available. Because beyond that point the probability of drawing any number
    # is completely different, comparing (1/56) to (1/75). Which includes the change in the number
    # of occurences a ball might collide with another ball while waiting to be drawn, changing the  
    # probability that it will even get drawn.
    # If 13 > date.year:
        # continue
