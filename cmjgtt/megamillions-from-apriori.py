...
# ...
# ...
# Find the differences between when they had 1 - 56 and 1 - 75 for each number between each set
# Find the multiplier that would work to balance out the two in the middle
# Create a new dataset that applies these weights to get the correct probabilities that are not skewed
# ...
# ...
